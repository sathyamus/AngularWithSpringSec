...
<link href='./static/css/font-awesome.css' rel="stylesheet" type="text/css"></link>
<link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
<script data-require="angular.js@*" data-semver="1.2.13" src="./static/js/angular-1.2.13.js"></script>
  <script data-require="angular-animate@*" data-semver="1.2.13" src="./static/js/angular-animate.js"></script>
<script type="text/javascript" src="./static/js/app.js"></script>
</head>
<body>

<div ng-controller="taskManagerController">
<h2 class="page-title">Deal Manager using Spring MVC 4 Rest &amp; AngularJS</h2>
